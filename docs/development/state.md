...
- **0.9.0** ✅ (this release) — Phase 1 security: 5 P0s from the 0.7.0 audit (chunked terminal, CL+TE, chunk overflow, redirect cred-strip + scheme-downgrade refusal, TLS-policy fail-closed).
