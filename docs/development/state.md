...
- **0.9.9** ✅ (this release) — Internal P1 self-audit. Trailer forbidden-name list expanded (Connection / Cookie / Proxy-Authorization). Two findings deferred to 1.0.x for fixup-cap reasons. ALPN, Huffman, redirect cred-strip, h2 forbidden filter all audited and sound.
