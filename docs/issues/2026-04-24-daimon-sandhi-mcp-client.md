...
- **HTTPS runtime currently blocked** (cross-link to `2026-04-24-fdlopen-getaddrinfo-blocked.md`). MCP endpoints that speak plain HTTP work fine; https:// MCP servers wait on the stdlib TLS-init fix.
